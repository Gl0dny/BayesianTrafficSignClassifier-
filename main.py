...
def main():
    ...
    subprocess.run([python_executable, 'train_gaussian_nb.py'], check=True)

    # Krok 5: Uczenie nieparametrycznego klasyfikatora Bayesa ( histogramy )
    print("Step 5: Training Histogram Bayes model...")
    subprocess.run([python_executable, 'train_histogram_nb.py'], check=True)
